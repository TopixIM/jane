...
(task-options!
  pom {:project     'topix/jane
       :version     +version+
       :description "Tiye server"
       :url         "https://github.com/TopixIM/jane"
       :scm         {:url "https://github.com/TopixIM/jane"}
...
(deftask rsync []
  (with-pre-wrap fileset
    (sh "rsync" "-r" "target" "tiye:servers/jane" "--exclude" "main.out" "--delete")
    fileset))
